      ...
      <div id="home-animation-wrapper" style="opacity: 0">
        ...
        >
          ...
          >
            <g id="svg-texts">
              <text
                transform="matrix(1 0 0 1 62.9893 351.1275)"
                style="fill:#FFFFFF;font-size:11em;"
              ></text>
            </g>
          </mask>
            ...
            <table id="table-modal">
              <tr>
                <td id="td1-modal">
                  ...
                  <p id="text-modal">
                    Seja muito bem-vindo ao Olympia! Esperamos que deixe
                    qualquer sentimento ruim de lado para mergulhar no incrível
                    mundo da arte com a gente! Talvez você esteja se perguntando
                    "para que serve esse site??"... uma breve introdução: se
                    prepare para publicar aquela pintura, linda foto ou divulgar
                    um grande teatro em que vai participar! Compartilhe com a
                    comunidade eventos artísticos e seja convidado para
                    palestras e workshops! Criamos até uma área chamada
                    "Inspire-se", prontinha para suas dicas artísticas ou frases
                    inspiradoras... não posso falar mais, sabe o porquê? Por que
                    você terá que se logar e experimentar esse lindo ambiente!
                  </p>
                </td>
              </tr>
            </table>
