...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="public/css/events-slider.css">
  ...
  <main class="main-content">
      ...
      <div class="slideshow-inner">
        <div class="slides">
          ...
          <div class="slide">
            ...
            <div class="image-container">
              <img src="https://www.alixbdanthenay.fr/wp-content/uploads/2016/11/20mars17-sans-typo.jpg" alt=""
                class="image" />
            </div>
          </div>
        </div>
    ...
    <div id="filter-container" data-aos="fade-down" data-aos-duration="1000">
      <ul id="radio-tab">
        ...
        <li class="radio-item">
          <label class="container">Pintura
            <input type="radio" name="radio">
            <span class="checkmark"></span>
          </label>
        </li>
        <li class="radio-item">
          <label class="container">Música
            <input type="radio" name="radio">
            <span class="checkmark"></span>
          </label>
        </li>
        <li class="radio-item">
          <label class="container">Teatro
            <input type="radio" name="radio">
            <span class="checkmark"></span>
          </label>
        </li>
        <li class="radio-item">
          <label class="container">Arquiteura
            <input type="radio" name="radio">
            <span class="checkmark"></span>
          </label>
        </li>
        <li class="radio-item">
          <label class="container">Dança
            <input type="radio" name="radio">
            <span class="checkmark"></span>
          </label>
        </li>
        <li class="radio-item">
          <label class="container">Literatura
            <input type="radio" name="radio">
            <span class="checkmark"></span>
          </label>
        </li>
        <li class="radio-item">
          <label class="container">Escultura
            <input type="radio" name="radio">
            <span class="checkmark"></span>
          </label>
        </li>
