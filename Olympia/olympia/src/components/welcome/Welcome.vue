    ...
    <div id="container-welcome">
      ...
      <div id="home-animation-wrapper" style="opacity: 0">
        ...
        <div class="info">
            ...
            <a class="link start"><svg class="svg-hand svg1" version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 462.8 580.9">

                <path class="st1 tap-target tap-target-1" d="M142.8,276.4c-0.1-51.8-0.2-81.5-0.2-102.6c0-45.9,76.5-48.1,80.7-3.1v104.4
                    c57.1-18,98.5-71.3,98.5-134.3C321.8,63,258.8,0,181,0S40.2,63,40.2,140.8C40.2,205.4,83.6,259.8,142.8,276.4z"/>

                <g class="hand hand-1">
                    <path class="st0 hand-untapped" d="M297.3,572.9c-46.1,0-94.4-5.9-126.1-15.4c-37.1-11.1-49.6-43.4-66.8-88.1c-16-41.4-35.9-93-82.7-154.7
                ...
                <g class="hand-tapping hand-tapping-1">
                    <path class="st0 hand-tapped" style="display:none" d="M297.3,572.9c-46.1,0-94.4-5.9-126.1-15.4c-37.1-11.1-49.6-43.4-66.8-88.1c-16-41.4-35.9-93-82.7-154.7
                        c-12.9-17.1-16.7-30.5-11.5-41c3.3-6.7,11.9-14.7,33.8-14.7c10.9,0,23.8,2.1,34.6,5.7l0.5,0.2l0.5,0.2c1,0.5,2.2,1,3.4,1.6
            ...
            <a class="link sobre"><svg class="svg-hand svg2" version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 462.8 580.9">

                <path class="st1 tap-target tap-target-2" d="M142.8,276.4c-0.1-51.8-0.2-81.5-0.2-102.6c0-45.9,76.5-48.1,80.7-3.1v104.4
                    c57.1-18,98.5-71.3,98.5-134.3C321.8,63,258.8,0,181,0S40.2,63,40.2,140.8C40.2,205.4,83.6,259.8,142.8,276.4z"/>
                ...
                <g class="hand-tapping hand-tapping-2">
                    <path class="st0 hand-tapped" style="display:none" d="M297.3,572.9c-46.1,0-94.4-5.9-126.1-15.4c-37.1-11.1-49.6-43.4-66.8-88.1c-16-41.4-35.9-93-82.7-154.7
                        c-12.9-17.1-16.7-30.5-11.5-41c3.3-6.7,11.9-14.7,33.8-14.7c10.9,0,23.8,2.1,34.6,5.7l0.5,0.2l0.5,0.2c1,0.5,2.2,1,3.4,1.6
                        c11.7,5.6,31.3,14.8,51.4,40.6v-4.8l0.6,1c-0.1-38-0.3-100.8-0.3-129.6c0-13.3,5.6-25,15.7-33c8.8-6.9,20.4-10.7,32.8-10.7
                        c21.4,0,45.6,12.5,48.2,39.8l0,0.4v56l1.8-1c7.5-4.2,19.1-9.2,32-9.2c13.8,0,33.2,5.9,47.1,33.9l2.7-1.5c9.8-5.6,20-8.6,29.5-8.6
