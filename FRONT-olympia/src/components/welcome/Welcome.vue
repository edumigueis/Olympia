    ...
    <div id="container-welcome">
      ...
      <div class="landing-top-bar">
        <div class="col">
          <img
            class="landing-logo"
            src="/src/assets/images/Logos/gradient-transparent-back-logo.png"
          />
      ...
      <div class="menu-ld">
        ...
        <div class="bottom-menu">
          <div class="bottom-top-menu">
            ...
            <br />
            <span class="language"
              ><i class="fas fa-globe"></i>Português (Brasil)</span
            >
          </div>
...
@font-face {
  ...
  .bg-module:nth-of-type(1) {
    -webkit-animation-delay: 55s;
    -moz-animation-delay: 55s;
    -o-animation-delay: 55s;
    animation-delay: 55s;
  }
  .bg-module:nth-of-type(2) {
    -webkit-animation-delay: 50s;
    -moz-animation-delay: 50s;
    -o-animation-delay: 50s;
    animation-delay: 50s;
  }
  .bg-module:nth-of-type(3) {
    -webkit-animation-delay: 45s;
    -moz-animation-delay: 45s;
    -o-animation-delay: 45s;
    animation-delay: 45s;
  }
  .bg-module:nth-of-type(4) {
    -webkit-animation-delay: 40s;
    -moz-animation-delay: 40s;
    -o-animation-delay: 40s;
    animation-delay: 40s;
  }
  .bg-module:nth-of-type(5) {
    -webkit-animation-delay: 35s;
    -moz-animation-delay: 35s;
    -o-animation-delay: 35s;
    animation-delay: 35s;
  }
  .bg-module:nth-of-type(6) {
    -webkit-animation-delay: 30s;
    -moz-animation-delay: 30s;
    -o-animation-delay: 30s;
    animation-delay: 30s;
  }
  .bg-module:nth-of-type(7) {
    -webkit-animation-delay: 25s;
    -moz-animation-delay: 25s;
    -o-animation-delay: 25s;
    animation-delay: 25s;
  }
  .bg-module:nth-of-type(8) {
    -webkit-animation-delay: 20s;
    -moz-animation-delay: 20s;
    -o-animation-delay: 20s;
    animation-delay: 20s;
  }
  .bg-module:nth-of-type(9) {
    -webkit-animation-delay: 15s;
    -moz-animation-delay: 15s;
    -o-animation-delay: 15s;
    animation-delay: 15s;
  }
  .bg-module:nth-of-type(10) {
    -webkit-animation-delay: 10s;
    -moz-animation-delay: 10s;
    -o-animation-delay: 10s;
    animation-delay: 10s;
  }
  .bg-module:nth-of-type(11) {
  ...
  .bg-module:nth-of-type(13) {
    -webkit-animation-delay: -3s;
    -moz-animation-delay: -3s;
    -o-animation-delay: -3s;
    animation-delay: -3s;
  }
  .bg-module:nth-of-type(14) {
  ...
  * {
  ...
  .dropdown-content > a:hover:nth-child(1) {
  ...
  a:hover > .arrow span:first-of-type {
    -webkit-transform: rotate(-45deg);
    transform: rotate(-45deg);
  }
  a:hover > .arrow span:last-of-type {
    -webkit-transform: rotate(45deg);
    transform: rotate(45deg);
  }
  .link-title {
  ...
  .button2 a:hover::after {
    box-shadow: 40px -20px 0px rgb(240,180,76), 41px -20px 8px rgba(0, 0, 0, 0.3),
      80px 20px 0px rgb(240,142,118), 81px 20px 8px rgba(0, 0, 0, 0.3),
      120px 60px 0px rgb(240,104,160), 121px 60px 8px rgba(0, 0, 0, 0.3),
      160px 100px 0px rgb(210,105,189), 161px 100px 8px rgba(0, 0, 0, 0.3),
  ...
  @media only screen and (max-width: 350px) {
    ...
    .signup-or-signin-form h1 {
      font-size: 1.4em;
    }
  }
  @media only screen and (min-height: 550px) and (max-height: 600px) and (max-width: 340px) {
    .phone-container {
      z-index: 2;
      margin-top: auto;
    }
  ...
  @media only screen and (min-height: 300px) and (max-height: 400px) and (max-width: 700px) {
    .signup-or-signin-form {
      top: -70px;
    }
  }
  ...
  @media only screen and (min-height: 400px) and (min-width: 310px) and (max-width: 340px) {
    .phone-container {
      margin-bottom: -100px !important;
    }
  }
  @media only screen and (min-height: 360px) and (max-height: 430px) and (max-width: 700px) {
    .phone-container {
  ...
  @media only screen and (min-height: 360px) and (max-height: 430px) and (max-width: 900px) {
    .signup-or-signin-form {
      bottom: -30px !important;
    }
  }
  @media only screen and (min-height: 760px) and (max-height: 860px) and (max-width: 400px) {
    .colunm-2 {
      margin-bottom: 0 !important;
      margin-top: -50px;
    }
