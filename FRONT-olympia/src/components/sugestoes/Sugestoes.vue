        ...
        <div class="wrapper-sec">
          ...
          <div class="module">
            <div class="flex-part">
              <div class="img-wp">
                <img
                  src="https://i.pinimg.com/originals/ff/77/56/ff7756247e080009b8418d80e47c5c91.png"
                />
              </div>
            </div>
            <div class="flex-part">
          ...
          <div class="module">
            <div class="flex-part">
              <div class="img-wp">
                <img
                  src="https://image.flaticon.com/icons/png/512/82/82582.png"
                />
              </div>
            </div>
            <div class="flex-part">
          ...
          <div class="module">
            <div class="flex-part">
              <div class="img-wp">
                <img
                  src="https://static.thenounproject.com/png/521193-200.png"
                />
              </div>
            </div>
            <div class="flex-part">
          ...
          <div class="module">
            <div class="flex-part">
              <div class="img-wp">
                <img
                  src="https://static.thenounproject.com/png/17840-200.png"
                />
              </div>
            </div>
            <div class="flex-part">
