            ...
            <table id="table-modal" class="table-modal-2">
              <tr>
                <td id="td1-modal">
                  ...
                  <p id="text-modal">
                    Aproveite aquela rolha de um bom vinho ou aquelas plantinhas
                    danadas que crescem no chão e faça esse belo jardim:<br />
                    1º) Com uma chave de fenda e com cuidado, faça um buraco do
                    topo até a metade de uma rolha; <br />
            ...
            <table id="table-modal" class="table-modal-3">
              <tr>
                <td id="td1-modal">
                  ...
                  <p id="text-modal">
                    O gradiente "Riacho Verde" é composto for duas cores frias e
                    calmantes. foi batizado assim para remeter a um bonito campo
                    com um riacho de águas cristalinas. É comprovado que essas
                    cores acalmam a mente, reduzindo a pressão arterial e
                ...
                <td id="td1-modal">
                  ...
                  <p id="text-modal" class="text-4">
                    ...
                    >
                      AQUI!</a
                    ><br /><br />
                    Por Amanda Capuano - Atualizado em 20 abr 2020 - Acessado em
                    02 mai 2020 - VEJA
                  </p>
                </td>
              </tr>
              ...
              <div class="slide__content" id="content-2">
                <!--<div class="masonry-item">
                  <div class="masonry-content">
                    ...
                    <p class="masonry-description">
                      ...
                      Assumenda modi inventore, totam vero consequuntur, aut
                      animi veritatis tempora nulla facere placeat velit illum
                      explicabo dicta enim ipsum. Vitae ducimus, ratione.
                    </p>
                  </div>
                </div>
                <div class="masonry-item">
                ...
                <div class="masonry-item">
                  <div class="masonry-content">
                    ...
                    <p class="masonry-description">
                      ...
                      repellendus beatae. Consequuntur molestias odio sapiente.
                      Officia minima, nisi! Tempora vero, architecto ducimus
                      animi nostrum nobis aliquid eligendi illo, facilis
                      temporibus.
                    </p>
                  </div>
                </div>
                <div class="masonry-item">
                  <div class="masonry-content">
                    ...
                    >
                    <p class="masonry-description">
                      Accusamus culpa maxime harum minus ipsa ea qui, blanditiis
                      sequi debitis. Temporibus quisquam consequatur dolor,
                      aliquid odio nulla dolorum animi quasi et! Reiciendis
                      ipsum repellendus quaerat explicabo, laboriosam amet,
                      temporibus at sed voluptatibus, minima quia.
                    </p>
                  </div>
                </div>
                <div class="masonry-item">
                ...
                <div class="masonry-item">
                  <div class="masonry-content">
                    ...
                    >
                    <p class="masonry-description">
                      Deleniti blanditiis iste cupiditate ea obcaecati corporis,
                      quas nobis possimus molestiae. Sed, minima.
                    </p>
                  </div>
                </div>
                <div class="masonry-item">
            ...
            $.ajax({
              ...
              success: function(result) {
                if (result.idUsuario != 0) {
                  ...
                  $("#obra-prof-name-link-" + index).text(
                    result.nome.replace("+", " ")
                  );
