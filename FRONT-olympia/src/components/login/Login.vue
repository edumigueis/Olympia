...
@font-face {
  font-family: "Bebas";
  src: url("/src/assets/fonts/BebasNeue.ttf");
}
...
#container-login {
  ...
  min-height: 100vh;
  z-index: 100;
  background: linear-gradient(-45deg, #eeb752 20%, #e73c7e);
...
.bubble:after {
  ...
  transition: 0.3s all;
  -webkit-animation: BubblesBackground 10s ease infinite;
  -moz-animation: BubblesBackground 10s ease infinite;
  -o-animation: BubblesBackground 10s ease infinite;
  animation: BubblesBackground 10s ease infinite;
}
.signup {
...
@-webkit-keyframes BubblesBackground {
  0% {
...
@-moz-keyframes BubblesBackground {
  0% {
    background-position: 0% 13%;
  }
  50% {
...
label.error {
  position: relative;
  background: url("/src/assets/images/unchecked.gif");
...
@font-face {
  font-family: Material-Design-Iconic-Font;
  src: url(/src/assets/fonts/Material-Design-Iconic-Font.woff2?v=2.2.0)
      format("woff2"),
    url(/src/assets/fonts/Material-Design-Iconic-Font.woff?v=2.2.0)
      format("woff"),
    url(/src/assets/fonts/Material-Design-Iconic-Font.ttf?v=2.2.0)
      format("truetype");
}
.zmdi {
  margin: 8px;
